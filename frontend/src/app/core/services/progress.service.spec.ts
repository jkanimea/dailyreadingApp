...
describe('ProgressService', () => {
  ...
  it('getSeriesProgress should call correct endpoint', () => {
    ...
    const req = httpMock.expectOne('https://localhost:5001/api/v1/progress/series/1');
  ...
  it('getStreak should call correct endpoint', () => {
    ...
    const req = httpMock.expectOne('https://localhost:5001/api/v1/progress/series/2/streak');
    req.flush(5);
  });

  it('getCompletionPercentage should call correct endpoint', () => {
    service.getCompletionPercentage(3).subscribe(p => expect(p).toBe(75));
    const req = httpMock.expectOne('https://localhost:5001/api/v1/progress/series/3/percentage');
    req.flush(75);
  });

  it('markComplete should POST', () => {
    service.markComplete(10).subscribe();
    const req = httpMock.expectOne('https://localhost:5001/api/v1/progress/10/complete');
