...
describe('ApiService', () => {
  ...
  it('should GET from the correct URL', () => {
    ...
    const req = httpMock.expectOne('https://localhost:5001/api/v1/test');
  ...
  it('should PUT to the correct URL with body', () => {
    ...
    const req = httpMock.expectOne('https://localhost:5001/api/v1/test/1');
  ...
  it('should pass HttpParams as query string', () => {
    ...
    const req = httpMock.expectOne(r => r.url === 'https://localhost:5001/api/v1/search');
