...
namespace EncounterDaily.Tests.UnitTests.Services
{
    ...
    public class AuthServiceTests
    {
        ...
        private readonly Mock<IRepository<RefreshToken>> _mockRefreshRepo;
        ...
        public AuthServiceTests()
        {
            ...
            _mockRefreshRepo = new Mock<IRepository<RefreshToken>>();

            _rsa = RSA.Create();

            _mockUow.Setup(u => u.Users).Returns(_mockUserRepo.Object);
            _mockUow.Setup(u => u.Repository<RefreshToken>()).Returns(_mockRefreshRepo.Object);
            ...
            _service = new AuthService(_mockUow.Object, _jwtSettings, _rsa);
        }
        ...
        {
            _mockRefreshRepo.Setup(r => r.GetAllAsync()).ReturnsAsync(new List<RefreshToken>());
        ...
        public async Task RefreshTokenAsync_ShouldThrow_WhenTokenReusedThreeTimes()
        {
            ...
            _mockRefreshRepo.Setup(r => r.GetAllAsync())
